...
namespace Gym_Managment
{
    public partial class EmployeeForm : Form
    {
        ...
        private void Add_Btn_Click(object sender, EventArgs e)
        {
            ...
            Employee NewMember = new Employee(fNameTxt.Text, LNameTxt.Text, AddressTxt.Text, Convert.ToInt32(contact_NoTxt.Text), Convert.ToDouble(SalaryTxt.Text), DateOfJoiningDT.Value);
